export default [
  ...
  },
  {
    ...
    collapsed: false,
    items: [
      { text: 'lodash', link: '/blog/lodash' },
      { text: 'luxon', link: '/blog/luxon' },
      { text: 'nprogress', link: '/blog/nprogress' },
      { text: 'sortablejs', link: '/blog/sortablejs' },
      { text: 'Vue3 右键菜单', link: '/blog/vue3-contextmenu' },
      { text: 'AOS 滚动动画', link: '/blog/aos' }
    ]
  },
  // {
  //   text: '网络',
  ...
  // },
  {
    ...
    collapsed: false,
    items: [
      { text: 'Vite 基本使用', link: '/blog/vite' },
      { text: '内置组件', link: '/blog/component' },
      { text: '组件通信', link: '/blog/component-communicate' },
      { text: '状态管理 Pinia', link: '/blog/pinia' },
