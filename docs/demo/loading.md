...
用户体验至关重要。为了吸引用户并改善网站的性能，添加动态和吸引人的 loading 效果是一个明智的选择。

## 概览

在本文中，我们将介绍 10 个引人注目的 CSS loading 效果，同时提供它们的实现方法。这些效果不仅令人印象深刻，而且可以提高用户对网站的满意度。
...
<div :class="`${$style.container} code-view`"><Loading1/></div>
...
<div :class="`${$style.container} code-view`"><Loading2/></div>
...
<div :class="`${$style.container} code-view`"><Loading3/></div>
...
<div :class="`${$style.container} code-view`"><Loading4/></div>
...
<div :class="`${$style.container} code-view`"><Loading5/></div>
...
<div :class="`${$style.container} code-view`"><Loading6/></div>
...
<div :class="`${$style.container} code-view`"><Loading7/></div>
...
<div :class="`${$style.container} code-view`"><Loading8/></div>
...
<div :class="`${$style.container} code-view`"><Loading9/></div>
...
>
  <defs>
    <clipPath id="ldio-3sqivj0p444-cp"><circle cx="50" cy="50" r="35"></circle></clipPath>
  </defs>
  <circle cx="50" cy="50" r="35" fill="#3d85c6"></circle>
  <g clip-path="url(#ldio-3sqivj0p444-cp)">
    <path
...
<div :class="`${$style.container} code-view`"><Loading10/></div>
...
>
  <defs>
    <clipPath id="ldio-zgwbo0tuqjm-cp">
    ...
    <g transform="scale(0.9)">
      <g transform="translate(-50 -50)">
        <g>
          ...
          ></animateTransform>
          <path
            clip-path="url(#ldio-zgwbo0tuqjm-cp)"
            fill="#fed778"
...
通过这 10 个不同的 CSS loading 效果，可以为网站或应用程序添加一些视觉吸引力，提高用户体验。

<script setup>
import Loading from '../components/loading/index.vue'
import Loading1 from '../components/loading/component/loading1.vue'
import Loading2 from '../components/loading/component/loading2.vue'
import Loading3 from '../components/loading/component/loading3.vue'
import Loading4 from '../components/loading/component/loading4.vue'
import Loading5 from '../components/loading/component/loading5.vue'
import Loading6 from '../components/loading/component/loading6.vue'
import Loading7 from '../components/loading/component/loading7.vue'
import Loading8 from '../components/loading/component/loading8.vue'
import Loading9 from '../components/loading/component/loading9.vue'
import Loading10 from '../components/loading/component/loading10.vue'
</script>
<style module>
.container {
  height: 120px;
